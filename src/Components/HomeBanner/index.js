  ...
  return (
    <div className="homeBannerSection">
      <Slider {...settings}>
        ...
        <div className="item">
          <img
            src="https://sslimages.shoppersstop.com/sys-master/root/hdc/h2f/32916137050142/selected-web_38-dk.jpg"
            alt="Banner 3"
          />
        </div>
        <div className="item">
          <img
            src="https://sslimages.shoppersstop.com/sys-master/root/hf4/h4c/33109699657758/Timex-web_9--ka9.jpg"
            alt="Banner 4"
          />
        </div>
      </Slider>
